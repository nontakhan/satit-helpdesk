...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-4">
    <div>
        <h2 class="report-page-title mb-1"><i class="bi bi-file-earmark-bar-graph text-primary"></i> รายงานการแจ้งซ่อม</h2>
        <p class="text-muted mb-0">วันที่ <?php echo date('d/m/Y', strtotime($start_date)); ?> ถึง
            <?php echo date('d/m/Y', strtotime($end_date)); ?>
        </p>
    </div>
    <a href="requests_list.php" class="btn btn-outline-primary">
        <i class="bi bi-list-check me-1"></i> รายการแจ้งซ่อม
    </a>
</div>
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card report-card report-stat-card h-100"
            style="background: linear-gradient(135deg, #071b33 0%, #123f73 62%, #1a4f86 100%);">
    ...
    <div class="col-md-4">
        <div class="card report-card report-stat-card h-100"
            style="background: linear-gradient(135deg, #ff8a00 0%, #ff5a00 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
    ...
    <div class="col-md-4">
        <div class="card report-card report-stat-card h-100"
            style="background: linear-gradient(135deg, #1a4f86 0%, #123f73 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
...
<div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header" style="background: linear-gradient(135deg, #071b33 0%, #123f73 62%, #1a4f86 100%);">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="text-center p-3 bg-light rounded">
                            <small class="text-muted d-block mb-1">เวลาที่ใช้</small>
    ...
    $(document).ready(function () {
        ...
        $('#reportTable').DataTable({
            ...
            buttons: [
                ...
                { extend: 'print', title: reportTitle, className: 'btn btn-sm btn-primary' }
            ],
            responsive: true,
        ...
        $('.view-detail-btn').on('click', function () {
            ...
            else if (statusName.indexOf('กำลัง') !== -1) statusClass = 'bg-primary';
            ...
            $('#modal-resolution-time').text(resTime !== '-' ? resTime + ' นาที' : '-');
