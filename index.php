...
<head>
    ...
    <title>satit-helpdesk - แจ้งซ่อม</title>
    ...
    <style>
        :root {
            --primary-color: #123f73;
            --secondary-color: #1a4f86;
            --accent-color: #ff5a00;
            --success-color: #1e9e71;
            --warning-color: #ff8a00;
            --danger-color: #d83b01;
            --light-bg: #f6f8fb;
            --card-shadow: 0 16px 36px rgba(18, 63, 115, 0.18);
            --gradient-bg: linear-gradient(135deg, #071b33 0%, #123f73 54%, #1a4f86 100%);
        }
        ...
        .header-section {
            background: linear-gradient(135deg, #071b33, var(--primary-color) 62%, var(--secondary-color));
            color: white;
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(18, 63, 115, 0.22);
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 10px 25px rgba(255, 90, 0, 0.32);
        }
                ...
                <div class="main-container">
                    ...
                    <div class="header-section">
                        <div class="logo-container">
                            <img src="assets/images/satit-PSU.png" alt="SATIT PSU Logo" class="logo-img">
                            <h1 class="card-title mb-2">ระบบแจ้งซ่อม satit-helpdesk</h1>
    ...
    <div class="modal fade" id="statusCheckSelectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="viewMyStatusBtn"><i
        ...
        $(document).ready(function () {
            ...
            function getStatusBadge(statusId, statusName) {
                const badges = {
                    ...
                    2: 'bg-primary text-white',  // กำลังดำเนินการ
